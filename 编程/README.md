...
更新时间：2026-09-12。当前阶段：Stage 5。本页只列当前源码、验证、运行证据与论文取数入口；历史目录保留在原处供复现，但不作主导航。Q4-3 P3 已完成人工验收冻结。
...
| Q4-3 | `q4_3_baseline/`、`config/q4_3_baseline.json` | `ACCEPTED / FROZEN` | `runs/q4_3_20260912_213133/人工验收.md`；主轨道 P3 |
...
- Q4-3：可见性规则为 `TIMESTAMP_LE_DECISION_VISIBLE`，以冻结 Q3 状态链为热身边界；主轨道冻结为 P3 / `P3_SHAPE_LEVEL`，人工验收记录见 `runs/q4_3_20260912_213133/人工验收.md`。论文可引用已验收指标，但比赛提交批准仍单独管理。
...
当前运行前，必须遵守[四问模型完整基线](../四问模型完整基线.md)和[人工操作指南](../人工操作指南.md)。
