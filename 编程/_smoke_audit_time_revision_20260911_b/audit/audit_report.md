...
> 状态：`FAIL`（脚本只读运行；未生成模型、预测或求解结果）  
> 生成时间：`2026-09-11T16:40:25+08:00`  
> 输入目录：`D:\Users\LENOVO\Desktop\数学建模\正式比赛C题`  
> 输出目录：`D:\Users\LENOVO\Desktop\数学建模\国赛团队共享工作区\编程\_smoke_audit_time_revision_20260911_b`  
...
| template_file_set | FAIL | error | actual=['result1.xlsx', 'result2.xlsx', 'result3.xlsx', 'result4-2.xlsx', 'result4-3.xlsx', '~$result1.xlsx', '~$result2.xlsx', '~$result3.xlsx', '~$result4-2.xlsx', '~$result4-3.xlsx'], expected=['result1.xlsx', 'result2.xlsx', 'result3.xlsx', 'result4-2.xlsx', 'result4-3.xlsx'] |
...
| result2.xlsx_计划购电量_interval_labels_parse | FAIL | error | first=0:10-0:20, last=0:00-0:10+1 |
| result2.xlsx_计划购电量_interval_sequence | FAIL | error | actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)] |
...
| result3.xlsx_计划购电量_interval_labels_parse | FAIL | error | first=0:10-0:20, last=0:00-0:10+1 |
| result3.xlsx_计划购电量_interval_sequence | FAIL | error | actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)] |
...
| result3.xlsx_调整购电量_interval_labels_parse | FAIL | error | first=0:10-0:20, last=0:00-0:10+1 |
| result3.xlsx_调整购电量_interval_sequence | FAIL | error | actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)] |
...
| result4-2.xlsx_计划购电量_interval_labels_parse | FAIL | error | first=0:10-0:20, last=0:00-0:10+1 |
| result4-2.xlsx_计划购电量_interval_sequence | FAIL | error | actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)] |
...
| result4-3.xlsx_计划购电量_interval_labels_parse | FAIL | error | first=0:10-0:20, last=0:00-0:10+1 |
| result4-3.xlsx_计划购电量_interval_sequence | FAIL | error | actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)] |
...
| result4-3.xlsx_调整购电量_interval_labels_parse | FAIL | error | first=0:10-0:20, last=0:00-0:10+1 |
| result4-3.xlsx_调整购电量_interval_sequence | FAIL | error | actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)] |
...
| template_open | FAIL | error | 无法读取 ~$result1.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result1.xlsx' |
| template_open | FAIL | error | 无法读取 ~$result2.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result2.xlsx' |
| template_open | FAIL | error | 无法读取 ~$result3.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result3.xlsx' |
| template_open | FAIL | error | 无法读取 ~$result4-2.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result4-2.xlsx' |
| template_open | FAIL | error | 无法读取 ~$result4-3.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result4-3.xlsx' |

## 4. 错误与告警

- `ERROR` `template_file_set`：actual=['result1.xlsx', 'result2.xlsx', 'result3.xlsx', 'result4-2.xlsx', 'result4-3.xlsx', '~$result1.xlsx', '~$result2.xlsx', '~$result3.xlsx', '~$result4-2.xlsx', '~$result4-3.xlsx'], expected=['result1.xlsx', 'result2.xlsx', 'result3.xlsx', 'result4-2.xlsx', 'result4-3.xlsx']
- `ERROR` `result2.xlsx_计划购电量_interval_labels_parse`：first=0:10-0:20, last=0:00-0:10+1
- `ERROR` `result2.xlsx_计划购电量_interval_sequence`：actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)]
- `ERROR` `result3.xlsx_计划购电量_interval_labels_parse`：first=0:10-0:20, last=0:00-0:10+1
- `ERROR` `result3.xlsx_计划购电量_interval_sequence`：actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)]
- `ERROR` `result3.xlsx_调整购电量_interval_labels_parse`：first=0:10-0:20, last=0:00-0:10+1
- `ERROR` `result3.xlsx_调整购电量_interval_sequence`：actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)]
- `ERROR` `result4-2.xlsx_计划购电量_interval_labels_parse`：first=0:10-0:20, last=0:00-0:10+1
- `ERROR` `result4-2.xlsx_计划购电量_interval_sequence`：actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)]
- `ERROR` `result4-3.xlsx_计划购电量_interval_labels_parse`：first=0:10-0:20, last=0:00-0:10+1
- `ERROR` `result4-3.xlsx_计划购电量_interval_sequence`：actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)]
- `ERROR` `result4-3.xlsx_调整购电量_interval_labels_parse`：first=0:10-0:20, last=0:00-0:10+1
- `ERROR` `result4-3.xlsx_调整购电量_interval_sequence`：actual_first_last=[(10, 20)]...[(1440, 1450)], expected_first_last=[(10, 20)]...[(1440, 1450)]
- `ERROR` `template_open`：无法读取 ~$result1.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result1.xlsx'
- `ERROR` `template_open`：无法读取 ~$result2.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result2.xlsx'
- `ERROR` `template_open`：无法读取 ~$result3.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result3.xlsx'
- `ERROR` `template_open`：无法读取 ~$result4-2.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result4-2.xlsx'
- `ERROR` `template_open`：无法读取 ~$result4-3.xlsx：[Errno 13] Permission denied: 'D:\\Users\\LENOVO\\Desktop\\数学建模\\正式比赛C题\\附件\\附件5\\~$result4-3.xlsx'
